...
New-ContainerDhcpSwitch
{
    ...
    # This fails on Nano:
	New-VmSwitch $global:SwitchName -NetAdapterName $netAdapter.Name -ErrorAction Ignore | Out-Null
}
...
New-ContainerNatSwitch
{
    ...
    New-VmSwitch $global:SwitchName -SwitchType NAT -NatSubnetAddress $SubnetPrefix -ErrorAction Ignore | Out-Null
}
...
New-ContainerNat
{
    ...
    New-NetNat -Name ContainerNAT -InternalIPInterfaceAddressPrefix $SubnetPrefix -ErrorAction Ignore | Out-Null
}
